$(function() {
	...
	$("#submit").hover(
		function() {
			$("#submit").attr("src", "/goods_ssh/images/login2.jpg");
		},
		function() {
			$("#submit").attr("src", "/goods_ssh/images/login1.jpg");
		}
	);
...
function validateVerifyCode() {
	...
	if(!value) {//非空校验
		...
		$.ajax({
			...
			url: "/goods_ssh/user_ajaxValidateVerifyCode.action",
...
function _change() {
	$("#vCode").attr("src", "/goods_ssh/checkImg.action?a=" + new Date().getTime());
}