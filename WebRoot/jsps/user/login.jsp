...
<script type="text/javascript">
  ...
  <body>
	<div class="main">
	  <div><img src="<c:url value='/images/basa.jpg'/>" /></div>
	  <div>
	    <div class="imageDiv"><img class="img" src="<c:url value='/images/tushu.jpg'/>"/></div>
        <div class="login1">
	      <div class="login2">
            <div class="loginTopDiv">
              <span class="loginTop">LJ会员登录</span>
              <span>
                <a href="<c:url value='/jsps/user/regist.jsp'/>" class="registBtn"></a>
              </span>
            </div>
            <div>
              <form target="_top" action="<c:url value='/user_login.action'/>" method="post" id="loginForm">
                  <table>
                    <tr>
                      <td width="50"></td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <img id="vCode" src="<c:url value='/checkImg.action'/>"/>
